...
class EditSafeCircleMain extends StatefulWidget {
  ...
  EditSafeCircleMain({required this.name, required this.email, Key? key}) : super(key: key);
...
// Access user data
  ...
  Future<void> updateSafePersonInFirestore(String originalName, String originalEmail, String newName, String newEmail) async {
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                            alignLabelWithHint: true, // Center the text vertically
                                      contentPadding: EdgeInsets.only(left: 2.w, bottom: 20.h, right: 10.w),
                                      hintText: 'Email',
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  if (emailController.text.isNotEmpty && nameController.text.isNotEmpty) {
                                    ...
                                    await updateSafePersonInFirestore(widget.name, widget.email, emailController.text, nameController.text);

                                    // Show a snackbar
                                    AppConstants.showCustomSnackBar("Safe Circle Person updated!");
