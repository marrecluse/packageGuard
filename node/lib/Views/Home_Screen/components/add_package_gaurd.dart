...
class _AddPackageGaurdState extends State<AddPackageGaurd> {
  ...
  void updateArmedStatus(bool isArmed) async {
      ...
      child: StreamBuilder(
          ...
          builder: (context, AsyncSnapshot<DatabaseEvent> snapshot) {
            if (!snapshot.hasData) {
              ...
              // print("you can toggle button from here $map");
              deviceId = map['SN83C048DF9D4']['device_id'] ?? 'No Device ID';
              battery =
                    ...
                    child: Column(
                      ...
                      children: [
                        ListTile(
                          ...
                          subtitle: CustomText(
                            title: deviceId, // Access device SSID
