...
GoogleSignUp({
  ...
  @override
  State<GoogleSignUp> createState() => _SignUpState();
}

class _SignUpState extends State<GoogleSignUp> {
  ...
  void _handleGoogleSignIn() async {
    try {
      ...
      if (_user != null) {
        // await checkAndCreateUserInFirestore(_user!);
        // Once user data is checked/created in Firestore, you can proceed with other actions in your app
        // For example, navigation to the home screen or updating UI based on successful sign-in
      }
    } catch (error) {
      print(error);
    }
...
print("User Name: ${widget.userName}");
    emailController.text = widget.userEmail ?? 'no';
    nameController.text = widget.userName ?? 'no';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        ...
                        child: CustomText(
                          title: "Fill the remaining fields",
                          fontSize: 20.sp,
