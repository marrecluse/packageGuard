...
class EditSafeCircleMain extends StatefulWidget {
  ...
  EditSafeCircleMain({required this.name, required this.phone, Key? key}) : super(key: key);
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  if (emailController.text.isNotEmpty && phoneController.text.isNotEmpty) {
                                    ...
                                    await updateSafePersonInFirestore(widget.name, widget.phone, emailController.text, phoneController.text);
