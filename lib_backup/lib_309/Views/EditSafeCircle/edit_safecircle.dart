...
class SafeCircleUser {
  ...
  SafeCircleUser({required this.userEmail, required this.userName,required this.userImage});
}
    ...
    FirebaseFirestore.instance
      ...
      querySnapshot.docs.forEach((doc) {
        ...
        if (name != null && email != null) {
          ...
          users.add(SafeCircleUser(userName: name, userEmail:email,userImage: image));
        }
      });
  ...
  Future<void> deleteSafeCircleUser(String name, String email) async {
    try {
      ...
      await FirebaseFirestore.instance
          .collection('safeCircle').doc(user?.uid).collection('circlePersons')
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                            ...
                            child: Padding(
                              ...
                              child: ClipOval(
                                child: Image.network(
                                  user.userImage.toString(), // Use the network URL directly
                                  height: 50.h,
                                  width: 50.h,
                                  fit: BoxFit.cover,
                                ),
                                  ...
                                  Row(
                                    children: [
                                      GestureDetector(
                                        onTap: () {
                                          Get.to( () => EditSafeCircleMain(name: user.userName, email: user.userEmail,),  );
                                                ...
                                                actions: [
                                                  ...
                                                  TextButton(
                                                    ...
                                                    onPressed: () {
                                                      ...
                                                      deleteSafeCircleUser(user.userName, user.userEmail);
                                                      Navigator.of(context).pop();
                                                    },
                                                  ),
                                                ],
